...
{
__main:
  %".2" = getelementptr inbounds [12 x i8], [12 x i8]* @"__string_2", i32 0, i32 0
  ...
  %".7" = getelementptr inbounds [15 x i8], [15 x i8]* @"__string_4", i32 0, i32 0
...
@"__string_2" = internal global [12 x i8] c"enter text:\00"
@"__string_3" = internal global [3 x i8] c"%s\00"
@"__string_4" = internal global [15 x i8] c"enter pattern:\00"

...
// selectionStatement: If LeftParen condition RightParen statement (Else statement)? | Switch
// LeftParen condition RightParen LeftBrace ( caseStatement )* RightBrace;
...
// iterationStatement: While LeftParen condition RightParen statement | Do statement While LeftParen
// expression RightParen Semi | For LeftParen (expression (Comma expression)*)? Semi expression?
...
// jumpStatement: (Break | Continue | Return expression? | Goto Identifier) Semi;
